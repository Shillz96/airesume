                    ...
                    <div className="cosmic-resume-section">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 p-6 bg-[#1a203c] rounded-lg border border-[#252a47]">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className="bg-[#0c101b] border-[#252a47] text-white"
                            placeholder="John"
                          />
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className="mt-6 mb-6 p-6 bg-[#1a203c] rounded-lg border border-[#252a47]">
                        <div className="space-y-2">
                          ...
                          />
                          <p className="mt-1 text-xs text-blue-300/70">A brief title that describes your professional identity</p>
                        </div>
                      </div>
                      ...
                      <div className="p-6 bg-[#1a203c] rounded-lg border border-[#252a47]">
                        <div className="space-y-2">
                          ...
                          <Textarea
                            ...
                            className="bg-[#0c101b] border-[#252a47] text-white min-h-[120px] resize-vertical"
                            rows={5}
                          ...
                          />
                          <div className="mt-4 text-xs text-blue-200 bg-blue-900/30 p-3 rounded-lg border border-blue-700">
