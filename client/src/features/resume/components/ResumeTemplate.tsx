 ...
 * 
 * This component renders a professional resume preview with sections for personal information,
 * experience, education, skills, and projects. It includes a download button for PDF export.
 */
